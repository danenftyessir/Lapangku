...
@section('title', 'Pending AI Validation')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Pending AI Validation</h1>
                <p class="text-gray-600 mt-2">Institutions waiting for AI document validation</p>
            </div>
