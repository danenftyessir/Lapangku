...
@section('title', 'Approved Institutions')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Approved Institutions</h1>
                <p class="text-gray-600 mt-2">Successfully verified and active institutions</p>
            </div>
